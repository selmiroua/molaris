...
export class SecretaryAppointmentListComponent implements OnInit {
  ...
  loadAppointments(): void {
    ...
    // Use getMyDoctorAppointments for doctors dashboard
      ...
      next: (appointments) => {
        ...
        appointments.forEach(appointment => {
          if (appointment.patient) {
            console.log(`Patient ${appointment.patient.prenom} ${appointment.patient.nom} - Profile Picture Path:`, 
              appointment.patient.profilePicturePath || 'No profile picture');
          }
          
          if (appointment.doctor) {
            console.log(`Doctor ${appointment.doctor.prenom} ${appointment.doctor.nom} - Profile Picture Path:`, 
              appointment.doctor.profilePicturePath || 'No profile picture');
          }
        });
