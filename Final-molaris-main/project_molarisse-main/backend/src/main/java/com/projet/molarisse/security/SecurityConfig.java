    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req -> 
                        ...
                        // Media endpoints - ensure they require authentication
                        .requestMatchers("/api/v1/api/messages/media/**").authenticated()
                        .requestMatchers("/api/messages/media/**").authenticated()
                        // Patient endpoints
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/users/profile/picture-by-id/**").permitAll()
                        ...
                        .requestMatchers("/api/doctor-verifications/statistics/**").hasRole("ADMIN")
                        .requestMatchers("/api/users/statistics/**").hasRole("ADMIN")
                        .requestMatchers("/api/appointments/statistics/**").hasRole("ADMIN")
                        ...
                        .requestMatchers("/api/patients/**").permitAll()
                        .requestMatchers("/api/secretaries").permitAll()
                        .requestMatchers("/api/secretaries/**").permitAll()
                        
                        .requestMatchers(HttpMethod.GET, "/api/appointments/doctor/**").hasRole("DOCTOR")
                        .requestMatchers(HttpMethod.GET, "/api/appointments/my-doctor-appointments").hasRole("DOCTOR")
                        .requestMatchers(HttpMethod.GET, "/api/appointments/secretary/**").hasRole("SECRETAIRE")
                        .requestMatchers(HttpMethod.PUT, "/api/appointments/status/{appointmentId}").hasAnyRole("SECRETAIRE","DOCTOR","PATIENT")
                        .requestMatchers(HttpMethod.PUT, "/api/appointments/update-status").hasAnyRole("SECRETAIRE","DOCTOR","PATIENT")
                        .requestMatchers(HttpMethod.POST, "/api/appointments/book-by-doctor").hasRole("DOCTOR")
                        .requestMatchers(HttpMethod.POST, "/api/appointments/book-for-unregistered-patient").hasAnyRole("SECRETAIRE", "DOCTOR")
                        .requestMatchers(HttpMethod.POST, "/api/appointments/book-for-unregistered-patient-by-doctor").hasRole("DOCTOR")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/bilans/me").hasRole("DOCTOR")
                        .requestMatchers(HttpMethod.GET, "/api/bilans/me").hasRole("DOCTOR")
                        ...
                        // Consultation endpoints
                        .requestMatchers(HttpMethod.POST, "/api/consultations/{id}/payment").hasAnyRole("DOCTOR", "SECRETAIRE")
                        .requestMatchers(HttpMethod.POST, "/api/consultations").hasAnyRole("DOCTOR", "SECRETAIRE")
                        .requestMatchers(HttpMethod.PUT, "/api/consultations/{id}").hasAnyRole("DOCTOR", "SECRETAIRE")
                        .requestMatchers(HttpMethod.GET, "/api/consultations/{id}").hasAnyRole("DOCTOR", "SECRETAIRE")
                        .requestMatchers(HttpMethod.GET, "/api/consultations/fiche/{fichePatientId}").hasAnyRole("DOCTOR", "SECRETAIRE")
                        
                        // Ordonnance endpoints - secure with proper role-based access
                        .requestMatchers(HttpMethod.POST, "/api/ordonnances").hasAnyRole("DOCTOR", "SECRETAIRE")
                        .requestMatchers(HttpMethod.PUT, "/api/ordonnances/{id}").hasAnyRole("DOCTOR", "SECRETAIRE")
                        .requestMatchers(HttpMethod.GET, "/api/ordonnances/{id}").hasAnyRole("DOCTOR", "SECRETAIRE", "PATIENT")
                        .requestMatchers(HttpMethod.GET, "/api/ordonnances/patient/{patientId}").hasAnyRole("DOCTOR", "SECRETAIRE", "PATIENT")
                        .requestMatchers(HttpMethod.GET, "/api/ordonnances/doctor/{doctorId}").hasAnyRole("DOCTOR", "SECRETAIRE")
                        .requestMatchers(HttpMethod.DELETE, "/api/ordonnances/{id}").hasAnyRole("DOCTOR", "SECRETAIRE")
                        .requestMatchers(HttpMethod.GET, "/api/ordonnances/exists").hasAnyRole("DOCTOR", "SECRETAIRE", "PATIENT")
                        .requestMatchers(HttpMethod.GET, "/api/ordonnances/by-patient-tooth").hasAnyRole("DOCTOR", "SECRETAIRE", "PATIENT")
