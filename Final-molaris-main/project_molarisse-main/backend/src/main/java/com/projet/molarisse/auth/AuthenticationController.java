...
public class AuthenticationController {
    ...
    /**
     * Get user info by email - used as a fallback for banned users
     * This is intentionally unprotected to allow banned users to get their role
     */
    @GetMapping("/user-info-by-email")
    public ResponseEntity<UserBasicInfoDto> getUserInfoByEmail(@RequestParam String email) {
...
class UserBasicInfoDto {
    ...
    public UserBasicInfoDto(String prenom, String nom, String email, String role, boolean accountLocked, boolean banned) {
        this.prenom = prenom;
        this.nom = nom;
        this.email = email;
        this.role = role;
