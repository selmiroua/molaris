        ...
        <div class="doctor-profile">
          <div class="doctor-header">
            <div class="doctor-avatar">
              <ng-container *ngIf="imageLoaded.profile; else profilePlaceholder">
...
export class DoctorDetailDialogComponent {
  ...
  onProfileImageLoad(): void {
    this.imageLoaded.profile = true;
  }
  
  handleProfileImageError(event: any): void {
    console.log('Profile image loading error, setting default image');
    this.imageLoaded.profile = false;
    event.target.style.display = 'none';
  }
