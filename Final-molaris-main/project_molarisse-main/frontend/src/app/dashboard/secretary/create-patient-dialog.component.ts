          ...
          <div class="form-section">
            ...
            <div class="form-row">
              <div class="field-container gender-container">
                ...
                <mat-error *ngIf="patientForm.get('sexe')?.hasError('required')">Le sexe est requis</mat-error>
              </div>
              
              <mat-form-field appearance="outline" class="form-field">
                <mat-label>Profession</mat-label>
                <input matInput formControlName="profession" required>
                <mat-error *ngIf="patientForm.get('profession')?.hasError('required')">La profession est requise</mat-error>
              </mat-form-field>
            </div>
            ...
            <div class="form-row">
              <mat-form-field appearance="outline" class="form-field">
                ...
                <mat-error *ngIf="patientForm.get('address')?.hasError('required')">L'adresse est requise</mat-error>
              </mat-form-field>
              
              <mat-form-field appearance="outline" class="form-field">
                <mat-label>État général</mat-label>
                <mat-select formControlName="etatGeneral" required>
                  <mat-option [value]="null" disabled selected>Choisissez l'état</mat-option>
                ...
                <mat-error *ngIf="patientForm.get('etatGeneral')?.hasError('required')">L'état général est requis</mat-error>
              </mat-form-field>
            </div>
          </div>
      ...
      .pipe(
        tap((response: any) => {
          ...
          const ficheData = {
            ...
            nom: this.patientForm.get('nom')?.value,
            prenom: this.patientForm.get('prenom')?.value,
            date_naissance: this.patientForm.get('dateNaissance')?.value,
