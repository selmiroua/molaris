...
@Component({
  ...
  template: `
    <div class="dialog-container">
      <h1 class="dialog-title">ÉDITER FICHE PATIENT</h1>
          ...
          <mat-form-field appearance="outline" class="full-width">
                ...
                <div class="form-group">
                  ...
                  <div class="select-container">
                    <select formControlName="etatGeneral">
                      <option value="" disabled>Sélectionnez votre état</option>
              ...
              <div class="form-row">
                ...
                <div class="form-group">
                  ...
                  <div class="input-with-icon">
                    ...
                    <input type="text" formControlName="adresse" placeholder="Adresse de résidence">
                  </div>
                </div>
              </div>
            </div>
            <div class="form-section">
              <div class="form-group full-width">
                ...
                <textarea formControlName="antecedentsChirurgicaux" rows="4" placeholder="Décrivez les antécédents chirurgicaux..."></textarea>
              </div>
            </div>
            <div class="form-section">
              <div class="form-group">
                ...
                <div class="radio-group modern">
                  ...
                  <div class="radio-option">
                    <input type="radio" id="medicationsNo" formControlName="priseMedicamentsOption" value="Non">
                ...
                <div class="allergies-container">
                  <div class="allergy-item">
                    ...
                    <div class="radio-group modern">
                      ...
                      <div class="radio-option">
                        <input type="radio" id="latexNo" formControlName="allergyLatex" value="Non">
                  ...
                  <div class="allergy-item">
                    ...
                    <div class="radio-group modern">
                      ...
                      <div class="radio-option">
                        <input type="radio" id="penicillinNo" formControlName="allergyPenicillin" value="Non">
                  ...
                  <div class="allergy-item">
                    ...
                    <div class="radio-group modern">
                      ...
                      <div class="radio-option">
                        <input type="radio" id="anestheticsNo" formControlName="allergyAnesthetics" value="Non">
                  ...
                  <div class="allergy-item">
                    ...
                    <div class="radio-group modern">
                      ...
                      <div class="radio-option">
                        <input type="radio" id="iodineNo" formControlName="allergyIodine" value="Non">
                  ...
                  <div class="allergy-item">
                    ...
                    <div class="radio-group modern">
                      ...
                      <div class="radio-option">
                        <input type="radio" id="metalsNo" formControlName="allergyMetals" value="Non">
                  ...
                  <div class="allergy-item">
                    ...
                    <div class="radio-group modern">
                      ...
                      <div class="radio-option">
                        <input type="radio" id="otherAllergiesNo" formControlName="allergyOther" value="Non">
            ...
            <div class="form-section">
              <div class="form-group full-width">
                <label>Observations dentaires</label>
                <textarea formControlName="observationsDentaires" rows="4" placeholder="Notes sur l'état bucco-dentaire..."></textarea>
              </div>
            </div>
          </div>
...
export class EditFicheDialogComponent implements OnInit {
  ficheForm: FormGroup;
  saving = false;
  patientId: number;
  ...
  loadFiche(): void {
    this.saving = true;
    this.patientService.getPatientFiche(this.patientId).subscribe({
      next: (fiche: FichePatient) => {
        this.ficheForm.patchValue({
          nom: fiche.nom || '',
          prenom: fiche.prenom || '',
          dateNaissance: fiche.dateNaissance ? new Date(fiche.dateNaissance) : '',
          sexe: fiche.sexe || '',
          profession: fiche.profession || '',
          telephone: fiche.telephone || '',
          adresse: fiche.adresse || '',
          etatGeneral: fiche.etatGeneral || '',
          antecedentsChirurgicaux: fiche.antecedentsChirurgicaux || '',
          priseMedicaments: fiche.priseMedicaments && fiche.priseMedicaments !== 'Aucune prise de médicaments' ? fiche.priseMedicaments : '',
          priseMedicamentsOption: fiche.priseMedicaments && fiche.priseMedicaments !== 'Aucune prise de médicaments' ? 'Oui' : 'Non',
          allergyLatex: fiche.allergies && fiche.allergies.includes('Latex') ? 'Oui' : 'Non',
          allergyPenicillin: fiche.allergies && fiche.allergies.includes('Pénicilline') ? 'Oui' : 'Non',
          allergyAnesthetics: fiche.allergies && fiche.allergies.includes('Anesthésiques locaux') ? 'Oui' : 'Non',
          allergyIodine: fiche.allergies && fiche.allergies.includes('Iode') ? 'Oui' : 'Non',
          allergyMetals: fiche.allergies && fiche.allergies.includes('Métaux') ? 'Oui' : 'Non',
          allergyOther: fiche.allergies && fiche.allergies.includes('Autre') ? 'Oui' : 'Non',
          otherAllergiesText: fiche.allergies && fiche.allergies.includes('Autre:') ? fiche.allergies.split('Autre:')[1]?.trim() : '',
          allergies: fiche.allergies || '',
          observationsDentaires: fiche.observationsDentaires || ''
        });
        this.saving = false;
      },
      error: () => {
        this.saving = false;
        this.snackBar.open('Impossible de charger la fiche patient', 'Fermer', { duration: 4000 });
      }
    });
  }
  ...
  saveFiche(): void {
    ...
    const fiche: FichePatient = {
      ...
      dateNaissance: this.ficheForm.value.dateNaissance ? new Date(this.ficheForm.value.dateNaissance) : null,
      patientId: this.patientId
    };
    delete fiche.priseMedicamentsOption;
    delete fiche.allergyLatex;
    delete fiche.allergyPenicillin;
    delete fiche.allergyAnesthetics;
    delete fiche.allergyIodine;
    delete fiche.allergyMetals;
    delete fiche.allergyOther;
    delete fiche.otherAllergiesText;
    this.patientService.updateFichePatient(this.patientId, fiche).subscribe({
      next: () => {
        this.saving = false;
